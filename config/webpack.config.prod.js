...
// TODO: remove "deploy" and merge to "master"
const pkg              = require(paths.appPackageJson)
let isCI               = process.env.CI && !_.includes(['deploy','master'], process.env.CIRCLE_BRANCH)
const homepagePath     = isCI ? `//${pkg.domain}/${process.env.CIRCLE_BRANCH}` : pkg.homepage
